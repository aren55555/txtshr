...
const FragmentErrorToast = (props: { reason: "invalid" | "unsupported"; version?: string }) => {
  ...
  return (
    ...
    >
      <div class="bg-red-400/30 backdrop-blur border border-red-400/[49] rounded-xl shadow-xl px-4 py-3 flex items-start gap-3">
        ...
        <p class="text-sm text-red-200 leading-relaxed">
          {props.reason === "unsupported"
            ? <>Unsupported link version (<code class="font-mono text-red-200">{props.version}</code>). Please use a newer viewer.</>
